...
public:
    ...
    inline const uint8_t *getFrameBuffer_mainThread() const
    {
...
protected:
    ...
    void frameAdd_workerThread(enum gspca_packet_type packet_type, const uint8_t *data, int len)
    {
        #if 0
...
const unsigned char* PS3EyeLibUSBCapture::getFrame() const
{
